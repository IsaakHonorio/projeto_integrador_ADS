# DIÁRIO DE CAMPO - PROJETO INTEGRADOR
...
| ATIVIDADES | PERÍODO DE REALIZAÇÃO | RELATO DO GRUPO | SITUAÇÃO |
| :--- | :---: | :--- | :--- |
| Criação do repositório no GitHub e organização das pastas. | 15/05/2026 | Criamos o repositório oficial do projeto no GitHub para centralizar o código e os documentos. Estruturamos a pasta principal e a pasta de dados brutos (Dados_brutos) para que todos os integrantes consigam trabalhar na mesma versão dos arquivos. | Atividade concluída. |
| Exportação e upload das matrizes de segurança (XP). | 17/05/2026 | Pegamos os modelos e questionários de avaliação de Segurança da Informação (da XP Investimentos) e exportamos os dados em formato .csv. Subimos estes arquivos com valores aleatórios para o GitHub para servir de base para o nosso banco de dados relacional. | Atividade concluída. |
| Análise de dados brutos e mapeamento de camadas. | 18/05/2026 | Analisamos os arquivos importados no GitHub, como o consolidador de tecnologias e controles. Começamos a mapear as colunas (Camada, Solução, Fabricante, Implantação) para identificar o que precisa ser limpo antes de alimentar o painel de BI. | Atividade concluída. |
| Preenchimento do formulário. | 19/05/2026 | O grupo reuniu-se para consolidar as informações recolhidas sobre a empresa Clube do Valor e preencher o formulário na plataforma da faculdade, definindo os objetivos, a justificativa e o cronograma. | Atividade concluída. |
...
| Encerramento da Etapa e Upload do Repositório | 22/06/2026 | Consolidamos a entrega final. Toda a documentação técnica (README.md), artefatos de BI e relatórios foram enviados ao repositório institucional, validando a rastreabilidade e a participação de todos os 6 integrantes por meio de commits individuais no GitHub.<br><br>**Evidência da reunião síncrona:**<br>![Reunião Alinhamento 12/04](Imagens_Registro/22-06-26.jpeg) | Atividade concluída. |
